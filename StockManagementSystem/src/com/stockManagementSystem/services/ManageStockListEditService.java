...
/**
 * Servlet implementation class ManageStockListEditService
 */
@WebServlet("/ManageStockListEditService")
public class ManageStockListEditService extends HttpServlet {
     ...
     */
    public ManageStockListEditService() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
	        ...
	        try{
	        	if (!item.isFormField() && buttonClicked.equals("buttonEdit") && item.getSize()>0) {
	        ...
	        if(buttonClicked.equals("buttonEdit"))
			{
				if(ManageStockDao.edit(id, description, deliveryDay, permittedBy, grantName, quantity, cost, isDeadStock)){  
					out.println("<script type=\"text/javascript\">");
					out.println("alert('stock edited');");
					out.println("location='manageStock.jsp';");
					out.println("</script>");
				}  
			    else{  
			    	out.println("<script type=\"text/javascript\">");
			    	out.println("alert('failed to edit stock');");
			    	out.println("location='manageStock.jsp';");
				    out.println("</script>");
			    }
		 	}
